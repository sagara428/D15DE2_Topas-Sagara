...
If after running the script many times with docker and then you suddenly experiencing BSOD when starting docker or device becomes so laggy, then maybe it is because docker is using too much diskspace.
